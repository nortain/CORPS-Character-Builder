...
export function ShamanSpellList(): Spell {
  return {
    ...
    spellEffectText: "You can grant regeneration equal to the regeneration table below to a friendly target or yourself.  You can then slide that target a number of squares equal to the slide distance.  As a swift action make an implement attack.",
    spellChart: [
      {
        ...new SpellChart(),
        rowName: "Regneration",
